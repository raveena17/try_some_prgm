...
class ProjectTest(TestCase):
    ...
    def test_manage_project_initiation(self):        
        ...
        response = self.client.post('/project/request/',
                                    {
                                    'name': 'Test project',
    ...
    def test_approve_manage_project_initiation(self):    
        ...
        response = self.client.post('/project/request/?id='
                                    + str(edit_project.id),
                                    {
    ...
    def test_list_project(self):        
        ...
        response = self.client.post('/project/list/')
        self.assertEquals(response.status_code, 200)
    ...
    def test_manage_project_status(self):
        ...
        response = self.client.post('/project/deactivate/',
    ...
    def test_update_project_type(self):
        ...
        response = self.client.post('/project/project_type/'
    ...
    def test_manage_domain(self):        
        response = self.client.post('/project/domain/', {'name': 'Python', },
        ...
        response = self.client.post('/project/domain/'
                                    + str(edit_domain.id) + '/',
                                    {
    ...
    def test_manage_development_env(self):        
        ...
        response = self.client.post('/project/dev_env/',
                                    {
    ...
    def test_project_plan(self):
        ...
        self.client = self._test_login_as_manager() 
        project = Project.objects.get(pk=1)
        response = self.client.post('/project/plan/?ids=' + str(project.id),
                                    {
                                    'planned_start_date': '02-06-2012',
                                    'planned_end_date': '08-09-2012',
