...
CHOICE_FIELDS = ['project_type', 'business_unit', 'development_process','delivery_centre',
                'customer','domain']
EMPTY_LABEL = [('','---------')]
...
class ProjectInitiationForm(forms.Form):
    ...
    delivery_centre = forms.ChoiceField(required=False)
...
class ProjectInitiationRequestForm(forms.ModelForm):
    ...
    class Meta:
        ...
        fields = ('name', 'approval_type', 'project_type', 'planned_effort',
                   ...
                   'project_no', 'objective', 'other_project_type', 'is_approvedby', 'customer','apex_body_owner','owner','project_owner','rejection_reason')
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields['business_unit'].queryset =  BusinessUnit.objects.exclude(
                                                        type__name = 'Customer').exclude(name = '5G-CG').exclude(name = '5G-PCG').exclude(name = '5G-PDG').exclude(name = '5G-PRG').exclude(name = '5G-PSG')
             
        self.fields['delivery_centre'].queryset =BusinessUnit.objects.exclude(
                                                        type__name = 'Customer').exclude(name = '5g India').exclude(name = '5g Canada').exclude(name = '5g Europe')
    ...
    def save(self, schedules, is_approved, commit = True):
        """
