...
class AnnouncementTest(TestCase):
    ...
    def setUp(self):
        ...
        User.objects.create(username='ashok', first_name='kumar',
                            email='ashok@5gindia.net', is_staff='1', is_active='1')
    ...
    def test_create_announcement(self):
        ...
        mail.outbox = []
        response = self.client.post('/announcement/create/')
        self.assertEquals(response.status_code, 200)
        response = self.client.post('/announcement/save/',
                                    {
    ...
    def test_update_announcement(self):
        ...
        response = self.client.post('/announcement/update/?ids='
    ...
    def test_approve_announcement(self):
        ...
        response = self.client.post('/announcement/approve/?ids='
    ...
    def test_delete_announcement(self):
        ...
        response = self.client.post('/announcement/delete/?msg=''&ids='
    ...
    def test_announcement_list(self):
        ...
        response = self.client.post('/announcement/list/')
        self.assertEquals(response.status_code, 200)
        self.assertEquals(len(response.context['datevalue']), 1)
        #search text in list
        response = self.client.post('/announcement/list/?search=sample')
        self.assertEquals(response.status_code, 200)
        self.assertEquals(len(response.context['datevalue']), 1)
    ...
    def test_view_announcement(self):
        ...
        all_announcement = Announcement.objects.all()
        response = self.client.get('/announcement/view/?ids='
