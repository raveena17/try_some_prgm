...
class AlertDataConfiguration(models.Model):
    ...
    toemail = models.ManyToManyField(User, related_name="%(app_label)s_%(class)s_alert_email")
    cc = models.ManyToManyField(User, related_name="%(app_label)s_%(class)s_alert_cc")
    bcc = models.ManyToManyField(User, related_name="%(app_label)s_%(class)s_alert_bcc")
    ...
    ###audit fields
    created_by = models.ForeignKey(User, null=True, related_name="%(app_label)s_%(class)s_alert_created")
    created_on = models.DateField(blank=True, null=True)
    modified_by = models.ForeignKey(User, null=True, related_name="%(app_label)s_%(class)s_alert_updated")
