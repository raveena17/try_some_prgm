...
class Travel(models.Model):
    ...
    requested_by = models.ForeignKey(User, null = True, related_name='travel_requested_by')
    approved_by = models.ForeignKey(User, null = True, related_name='travel_approved_by' )
    final_approver = models.ForeignKey(User,null = True, related_name='travel_final_approver')
